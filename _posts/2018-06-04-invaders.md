...
![c2](invaders_imgs/Panel_Dashboard.png "Main dashboard")

A list of the infected machines and what system specifications these had:
![c2](invaders_imgs/Panel_Machines.png "Specifications of infected hosts")

An input form that allows the actors to change the parameters for the cryptocurrency miners:
![c2](invaders_imgs/Panel_Arguments.png "Arguments to be distributed to the miners")
